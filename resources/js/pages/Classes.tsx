...
export default function Classes() {
  ...
  return <div className="space-y-6">
    <div className="flex flex-col gap-4 rounded-3xl bg-gradient-to-r from-emerald-700 to-emerald-600 p-6 text-white shadow-xl shadow-emerald-900/20 sm:flex-row sm:items-center sm:justify-between"><div><p className="text-sm font-medium text-emerald-100">Akademik</p><h1 className="text-2xl font-black sm:text-3xl">Kelas</h1><p className="mt-1 text-sm text-emerald-50">Atur rombongan belajar dan wali kelas.</p></div><Button className="bg-white text-emerald-700 hover:bg-emerald-50" onClick={() => { reset(); setEditingId(null); setShowForm(true); }}><Plus className="h-4 w-4" /> Tambah Kelas</Button></div>
